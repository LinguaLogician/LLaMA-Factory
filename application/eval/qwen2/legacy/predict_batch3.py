...
# 配置参数
FILE_NAME = 'MIT_separated'
MODEL_NAME = 'qwen205_moltrans_mit_separated_space_lora_para1'
...
# python ./application/eval/qwen2/predict_batch3.py 2>&1 | tee -a logs/predict/qwen205_moltrans_mit_separated_space_lora_para1.log
