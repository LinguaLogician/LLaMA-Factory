...
# 配置参数
FILE_NAME = 'MIT_mixed_augm'
MODEL_NAME = 'qwen2_0_5b_molecular_transformer_mit_mixed_augm_lora_sft_epoch_3'
DATA_PATH = '/home/liangtao/DataSets/Chemistry/MolecularTransformer/test/MIT_mixed_augm.json'
...
# python ./application/eval/qwen2/predict_batch2.py 2>&1 | tee -a logs/predict/qwen2_0_5b_molecular_transformer_mit_mixed_augm_lora_sft_epoch_3.log
