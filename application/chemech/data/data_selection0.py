...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir1", default="/mnt/e/DataSets/Chemistry/ChemechProcessing",
    ...
    parser.add_argument("--data_file", default="mech-USPTO-31k_train0.json", help="Mechanism data file name")
