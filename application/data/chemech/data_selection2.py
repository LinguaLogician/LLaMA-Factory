...
def match_strategy(uspto_item: Dict[str, Any], mech_item: Dict[str, Any], strategy: int) -> bool:
    ...
    if strategy == 1:
        ...
        return (uspto_item['amrxts_cano'] == mech_item['amrxts_cano_in_ori'] or
        ...
        return (uspto_item['amrxts_cano'] == mech_item['amrxts_cano_in_upd'] or
        ...
        return (uspto_item['rxts_cano'] == mech_item['rxts_cano_in_ori'] or
        ...
        return (uspto_item['rxts_cano'] == mech_item['rxts_cano_in_upd'] or
...
if __name__ == "__main__":
    ...
    # 修改data_dir2为/mnt/e/DataSets/Chemistry/Chemech
    parser.add_argument("--data_dir2", default="/mnt/e/DataSets/Chemistry/Chemech",
    ...
    parser.add_argument("--version", default="v2", help="Version")
