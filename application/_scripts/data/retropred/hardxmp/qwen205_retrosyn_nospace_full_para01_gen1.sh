...
MODEL_NAME="qwen205_retrosyn_nospace_full_para01"
MODEL_PATH="/home/liangtao/Development/LLMSpace/LLaMA-Factory/output"
DATA_FILE="inout_augm.json"
CHECKPOINTS=""
FILE_PREFIX="retrosyn_nospace_hardxmp"
DATA_DIR="/mnt/e/DataSets/Chemistry/RetroPrediction/HardExamples/train_augm/v1"
PREDICTION_BASE_DIR="/mnt/e/DataSets/Chemistry/RetroPrediction/HardExamples/train_augm/v1/pred_train"
