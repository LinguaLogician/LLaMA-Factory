...
# 格式: "配置文件路径:额外参数"
TASKS=(
    "application/chemech/eval/_config/multi_task/rest_v6_1_and_v7_1.json:--batch_limit 3"
    "application/chemech/eval/_config/single_task/rest_task_v1.json:--batch_limit 3"
)
