...
# 格式: "配置文件路径:额外参数"
TASKS=(
    "application/chemech/eval/_config/single_task/rest_task_v2.json:--batch_limit 3"
    "application/chemech/eval/_config/multi_task/enhc_rxts_to_prds_v2_1.json:--batch_limit 3"
)
