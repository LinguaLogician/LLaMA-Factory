...
TASKS=(
    # 多任务配置
#    "application/chemech/eval/_config/multi_task/enhc_rxts_to_prds_v6_1_and_v7_1.json:--batch_limit 3"
    # 单任务配置
    "application/chemech/eval/_config/single_task/rxts_to_rxts_v1.json:--batch_limit 3"
)
...
#    # 修改这一行：
    python -u "${BASE_DIR}/application/chemech/eval/batch_predict_score.py" \
      --config_file "$CONFIG_FILE" \
      --output_base_dir "results/chemechpred/prediction" \
      --score_base_dir "results/chemechpred/scores" \
