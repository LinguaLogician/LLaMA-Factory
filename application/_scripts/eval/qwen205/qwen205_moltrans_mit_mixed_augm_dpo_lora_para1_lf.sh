#!/bin/bash
#/mnt/e/CheckPoints/ChemicalFactory/output/qwen205_moltrans_mit_mixed_augm_dpo_lora_para1_lf
MODEL_NAME="qwen205_moltrans_mit_mixed_augm_dpo_lora_para1_lf"
