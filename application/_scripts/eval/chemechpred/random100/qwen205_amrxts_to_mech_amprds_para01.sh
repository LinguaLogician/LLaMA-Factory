...
MODEL_NAME="qwen205_amrxts_to_mech_amprds_para01"
TASK_ID="AMRXTS_TO_MECH_AMPRDS"

# 数据路径参数
DATA_DIR="/mnt/e/DataSets/Chemistry/ChemicalMechanism/test/random100"
PREDICTION_OUTPUT_DIR="/mnt/e/Development/LLMSpace/LLaMA-Factory/results/chemechpred/prediction/random100"
SCORE_OUTPUT_DIR="/mnt/e/Development/LLMSpace/LLaMA-Factory/results/chemechpred/scores/random100"
