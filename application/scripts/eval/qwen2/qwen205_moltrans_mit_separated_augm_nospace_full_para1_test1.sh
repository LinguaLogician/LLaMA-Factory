...
MODEL_NAME="qwen205_moltrans_mit_separated_augm_nospace_full_para1"
MODEL_PATH="/home/liangtao/Development/LLMSpace/LLaMA-Factory/output"
DATA_FILE="MIT_separated_augm.json"
CHECKPOINTS="checkpoint-300639"
FILE_PREFIX="mit_separated_augm_nospace_test"
...
process_checkpoint "checkpoint-300639"
if [ $? -ne 0 ]; then
