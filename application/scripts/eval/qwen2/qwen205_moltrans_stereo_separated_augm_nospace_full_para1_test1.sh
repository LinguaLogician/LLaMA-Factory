...
MODEL_NAME="qwen205_moltrans_stereo_separated_augm_nospace_full_para1"
MODEL_PATH="/home/liangtao/Development/LLMSpace/LLaMA-Factory/output"
DATA_FILE="STEREO_separated_augm.json"
CHECKPOINTS="checkpoint-663396"
FILE_PREFIX="stereo_separated_augm_nospace_test"
...
process_checkpoint "checkpoint-663396"
if [ $? -ne 0 ]; then
