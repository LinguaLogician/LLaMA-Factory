...
MODEL_NAME="qwen205_moltrans_stereo_separated_nospace_full_para1"
MODEL_PATH="/home/liangtao/Development/LLMSpace/LLaMA-Factory/output"
DATA_FILE="STEREO_separated.json"
CHECKPOINTS="checkpoint-331698"
FILE_PREFIX="stereo_separated_nospace_test"
...
process_checkpoint "checkpoint-331698"
if [ $? -ne 0 ]; then
